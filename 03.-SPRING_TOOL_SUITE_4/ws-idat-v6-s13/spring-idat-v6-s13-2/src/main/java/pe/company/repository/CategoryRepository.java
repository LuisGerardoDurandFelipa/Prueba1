...
public interface CategoryRepository extends CrudRepository<Categoria, Long>{
	 ...
	 * **/
	@Query("INSERT INTO Categoria (id_categoria,descripcion) VALUES (:id_categoria,:descripcion)") 
	Categoria insertarCategoria(@Param("descripcion") Long id_categoria ,String descripcion);
